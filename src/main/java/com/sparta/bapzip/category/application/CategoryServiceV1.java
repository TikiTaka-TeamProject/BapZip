...
public class CategoryServiceV1 {
    ...
    CategoryEntity getCategory(UUID categoryId) {
        return categoryRepository.findById(categoryId)
                .orElseThrow(() -> new RuntimeException(String.valueOf(ErrorCode.CATEGORY_NOT_FOUND)));
    }
    // 삭제되지 않은 카테고리 리스트 조회
    ...
    public CategoryDetailResponse updateCategory(UUID categoryId, String name, String content, Long userId) {
        ...
        category.updateCategory(name, content);
